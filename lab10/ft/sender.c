...
void init(){
    ...
    //printf("My MAC for device %s is %.2X-%.2X-%.2X-%.2X-%.2X-%.2X \n", device_name, my_mac[0] , my_mac[1] , my_mac[2] , my_mac[3] , my_mac[4] , my_mac[5]);
//    ret = getMACfromDev(device_name, dest_mac);
//    if(ret != 0)
